...
- ~~**크로스윈드 중심선 정밀도**: ±150~320m~~ → **M23에서 해결.** 요-레이트 댐퍼(qScale 게인스케줄)로
  Dutch-roll 발산을 잡아 중심선 추종 ~90~100m로 개선. 잔여 ~90m는 단거리 디크랩 트랜지언트(후속:
  접지 직전 자동 디크랩).
- estimated nav 크로스윈드 착륙, GPS 스푸핑 중 크로스윈드 착륙(후속).
